...
| # | commit | acceptance_length | status | description |
|---|--------|---------------|--------|-------------|
| 1 | 06f56e0 | 0tokens | keep | DDTreeProposer implementation with tree building, attention mask, and KV cache compaction |
